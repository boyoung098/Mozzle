...
<script>
	window.onload = function() {
		...
		var swiper_n = new Swiper(".sw-new-mozzle1", {
			slidesPerView : 4,
			spaceBetween : 50,
			loop : false,
		});
		...
		var swiper_n = new Swiper(".sw-new-mozzle3", {
			slidesPerView : 4,
			spaceBetween : 50,
			loop : false,
		});
...
<body>
	...
	<c:if test="${userId != null}">	
		<section class="container mt-3" id="new-mozzle1">
	...
	<br />
	<section class="container mt-3" id="new-mozzle3">
		<h4>Best 모즐!</h4>
		<div class="swiper-container sw-new-mozzle3">
